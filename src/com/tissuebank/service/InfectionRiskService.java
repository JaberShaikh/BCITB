...
public interface InfectionRiskService 
{
	...
	InfectionRisk populateInfectionRiskVariousBits(InfectionRisk infection_risks, String whichDepartment, String whatToProcess);
